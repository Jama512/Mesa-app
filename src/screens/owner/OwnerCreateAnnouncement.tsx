...
// Importamos el Hook que creamos para el Sprint 2
...
const styles = StyleSheet.create({
  ...
  textArea: { height: 120, fontSize: 13, fontWeight: "600", textAlignVertical: "top" },
  primaryButton: { marginTop: 14, borderRadius: 999, paddingVertical: 13, alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 8 },
  primaryText: { color: "#FFFFFF", fontWeight: "900", fontSize: 14 },
  helper: { marginTop: 10, fontSize: 11, fontWeight: "700", opacity: 0.9, textAlign: "center" },
});
