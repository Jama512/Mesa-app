...
// ✅ CAMBIO CLAVE: Importamos el Hook (ViewModel) en lugar de hacer la lógica aquí
...
const OwnerMenuList: React.FC = () => {
  ...
  // ✅ USAMOS EL HOOK:
  // Extraemos los datos listos y las funciones ya preparadas.
  // La pantalla ya no "piensa", solo obedece al hook.
  const {
    dishes,
    isOpen,
    subtitle,
